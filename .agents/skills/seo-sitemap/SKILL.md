...
[OK] Integration pages (with real setup docs)
[OK] Template/tool pages (with downloadable content)
[OK] Glossary pages (200+ word definitions)
[OK] Product pages (unique specs, reviews)
[OK] User profile pages (user-generated content)

### Penalty Risk (avoid at scale)
[ERROR] Location pages with only city name swapped
[ERROR] "Best [tool] for [industry]" without industry-specific value
[ERROR] "[Competitor] alternative" without real comparison data
[ERROR] AI-generated pages without human review and unique value
