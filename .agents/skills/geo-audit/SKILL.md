...
[ERROR] **Don't use geo-audit if:**

1. **User wants a traditional SEO audit (technical, on-page, content)**
   - GEO audit focuses on AI citability and generative engine optimization, not traditional SEO
   - [OK] Use instead: **seo-audit** skill (covers crawlability, indexation, page speed, meta tags, etc.)

2. **User wants keyword research**
   - GEO audit analyzes existing content for AI citability, doesn't discover new keywords
   - [OK] Use instead: **keyword-research** workflow → then optimize content for AI with **ai-seo** skill

3. **User wants to write or optimize a single piece of content**
   - GEO audit is site-wide, not page-specific
   - [OK] Use instead: **ai-seo** skill (optimizes individual pages/articles for AI citation)

4. **User wants to build programmatic pages at scale**
   - GEO audit evaluates content quality, doesn't generate pages
   - [OK] Use instead: **programmatic-seo** skill → then audit with geo-audit after pages are live

5. **User wants schema markup implementation only**
   - GEO audit identifies missing schema but doesn't write the JSON-LD code
   - [OK] Use instead: **schema-markup** skill (generates ready-to-use structured data)

6. **User wants competitor keyword gap analysis**
   - GEO audit doesn't analyze competitors' rankings
   - [OK] Use instead: **competitor-gap** workflow

7. **User wants a monthly SEO report**
   - GEO audit is a point-in-time snapshot, not ongoing tracking
   - [OK] Use instead: **monthly-report** workflow (tracks rankings, traffic, GSC data over time)

8. **User wants content strategy planning**
   - GEO audit evaluates existing content, doesn't plan new topics
   - [OK] Use instead: **content-strategy** skill → then audit with geo-audit after content is published

9. **Site has < 5 pages total**
   - GEO audit crawls up to 50 pages; too much overhead for tiny sites
   - [OK] Use instead: Manual **ai-seo** optimization of each page

10. **User wants link building or off-page SEO**
    - GEO audit focuses on on-page AI optimization signals
    - [OK] Use instead: **link-building** workflow

11. **User wants site architecture or URL structure planning**
    - GEO audit doesn't redesign site hierarchy
    - [OK] Use instead: **site-architecture** skill

12. **User wants conversion rate optimization (CRO)**
    - GEO audit optimizes for AI visibility, not conversions
...
- **ai-seo**: For optimizing individual pages/content for AI citation (narrower scope than full GEO audit)
- **schema-markup**: For implementing structured data identified in audit
- **content-strategy**: For planning content that AI systems will want to cite
- **site-architecture**: For improving site structure to help AI crawlers understand content relationships
