...
This will:
1. Fetch top ranking pages using DuckDuckGo or playwriter C (90 days)
...
4. Identify coverage gaps using GSC or DuckDuckGo AI
...
- Average position
- Identify themes and common patterns using free AI analysis
- Total impressions
...
**Time:** 2-3 minutes
**API Cost:** Free (using DuckDuckGo/WebSearch)
