...
2. Analyze competitor content patterns
3. Identify gaps (topics they cover, you don't)
4. Use DuckDuckGo AI for search volume estimates
...
**Time:** 3-5 minutes
**API Cost:** Free (DuckDuckGo/Manual Analysis)
